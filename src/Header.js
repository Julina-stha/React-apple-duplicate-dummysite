  ...
  return (
    <div className='col-12'>
      <ul className="head-content">
        ...
        <li><a href="https://www.apple.com/uk/store" target="_blank" rel="noreferrer" id="header-link"><img src="https://img.icons8.com/ios/15/ffffff/shopping-bag--v1.png"/></a></li>
      </ul>
    </div>
